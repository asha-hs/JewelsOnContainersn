...
namespace CartApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ICartRepository, RadisCartRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CartApi", Version = "v1", Description="The Basket Service HTTP Api" });
